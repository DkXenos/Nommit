...
// API keys live in local.properties (git-ignored) and are never committed.
// See §4 of prompt.md for the Google Cloud setup the human must do.
...
android {
    ...
    defaultConfig {
        applicationId = "com.example.nommit"
        minSdk = 26
        targetSdk = 37
        versionCode = 1
        versionName = "1.0"
